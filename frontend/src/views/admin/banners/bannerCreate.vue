        ...
        <form @submit.prevent="createBanner">
          <div class="row g-4">
            <div class="col-12 col-md-6">
              ...
              <input v-model="form.title" type="text" class="form-control" placeholder="Enter banner title" />
            </div>

            <div class="col-12 col-md-6">
              <label class="form-label">Link URL</label>
              <input v-model="form.link" type="text" class="form-control" placeholder="Enter link URL" />
            </div>
